...
if __name__ == "__main__":
    ...
    # ([28, 28, 28, 1], 5001, TEST_SPAM, TRAIN_SPAM, VALIDATE_SPAM, 'SpamData'),
    # ([4, 4, 4, 1], 5001, TEST_HTRU2, TRAIN_HTRU2, VALIDATE_HTRU2, 'HTRU2Data')
    main([8, 4, 4, 4, 1], 5001, TEST_DATA_FILE,
