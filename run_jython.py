...
TEST_SPAM = 'data/{}_test.csv'.format('SpamData')
TRAIN_SPAM = 'data/{}_train.csv'.format('SpamData')
VALIDATE_SPAM = 'data/{}_validate.csv'.format('SpamData')

TEST_HTRU2 = 'data/{}_test.csv'.format('HTRU2Data')
TRAIN_HTRU2 = 'data/{}_train.csv'.format('HTRU2Data')
VALIDATE_HTRU2 = 'data/{}_validate.csv'.format('HTRU2Data')
...
experiment_data = [
    ...
    #([57, 28, 28, 28, 1], 5001, TEST_SPAM, TRAIN_SPAM, VALIDATE_SPAM, 'SpamData')
    ([8, 4, 4, 4, 1], 5001, TEST_HTRU2, TRAIN_HTRU2, VALIDATE_HTRU2, 'HTRU2Data')
    ]
...
#aws sms publish --region us-east-2 --phone-number +19176974759 --message "All done"
